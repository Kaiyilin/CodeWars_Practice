...
def model_builder(hp):
    ...
    model = Resnet3DBuilder.build_resnet_101((64, 64, 64, 1), 2,reg_factor=hp_reg_factor)
...
tuner = kt.Hyperband(model_builder,
                     ...
                     max_epochs = 100,
                     directory = hp_dir,
                     project_name = 'Res101_Tuninig_BAHC_retune')
...
tuner = kt.Hyperband(model_builder,
                     ...
                     max_epochs = 100,
                     directory = hp_dir,
                     project_name = 'Res101_Tuninig_BABB_retune')
...
tuner = kt.Hyperband(model_builder,
                     ...
                     max_epochs = 100,
                     directory = hp_dir,
                     project_name = 'Res101_Tuninig_BBHC_retune')
