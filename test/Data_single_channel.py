# data_aug_single
# data_augmentation
# using sparse_categorical_crossentropy, one hot transformation is unecessary
...
"""
BA_images_tr, BA_images_val = BA_alff_tr[...,None], BA_alff_val[...,None]
BB_images_tr, BB_images_val = BB_alff_tr[...,None], BB_alff_val[...,None]
HC_images_tr, HC_images_val = HC_alff_tr[...,None], HC_alff_val[...,None]
"""
...
BA_ds_tr, BA_ds_val = tfdata_shuffle_and_split(BA_images_tr, BA_labels_tr, split_number= 5)
BB_ds_tr, BB_ds_val = tfdata_shuffle_and_split(BB_images_tr, BB_labels_tr, split_number= 4)
HC_ds_tr, HC_ds_val = tfdata_shuffle_and_split(HC_images_tr, HC_labels_tr, split_number= 5)
...
with strategy.scope():
    os.chdir(logdir)
    model = Resnet3DBuilder.build_resnet_50((128, 128, 128, 1), 3,reg_factor=1e-4)
    ...
    #base_model = base_model_creator(model, train_para = True)
    #input_layer = tf.keras.Input(shape = (128, 128, 128, 5))
