...
from Data_split_10_tr_test import *
import IPython
...
def model_builder(hp):
    ...
    model = Resnet3DBuilder.build_resnet_101((64, 64, 64, 1), 3,reg_factor=hp_reg_factor)
...
model.save('Res_101_3D_unaug.h5')