...
with strategy.scope():
    ...
    #weights_path = '/home/user/venv/kaiyi_venv/training_checkpoints/20200813-093721/weights-151.hdf5'
    ...
    history = model.fit( ds_tr.map(tf_random_rotate_image_xyz).cache().shuffle(buffer_size=_buffer_size).batch(_batch_size),
                             class_weight = None,
                             epochs=200,
                             verbose=1,
                             callbacks=callbacks,
